...
*/		
		function seeColor(test) {
			if (test.substring(0, 3) === 'red') {
				return test.substring(0, 3);
			} else if (test.substring(0, 4) === 'blue') {
...
*/
		function frontAgain(test) {
			if (test.substring(0, 2) === test.substring(test.length - 2)) {
				return true;
...
10. **filterBigNumbers** Write a function that filters numbers greater than or equal to 100.
	...
	filterBigNumbers([]) → []
*/
		function filterBigNumbers(array1) {
			let array2 = [];
			for (let i = 0; i < array1.length; i++) {
				if (array1[i] >= 100) {
					array2.push(array1[i]);
...
*/
		function filterMultiplesOfX(array1, x) {
			let array2 = [];
			for (let i = 0; i < array1.length; i++) {
				if (array1[i] % x === 0) {
					array2.push(array1[i]);
